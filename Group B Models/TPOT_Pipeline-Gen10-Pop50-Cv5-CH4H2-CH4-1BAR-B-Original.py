...
tpot_data = pd.read_csv('C:/Users/gaksu/Desktop/github/Raw Data/HypoCOF-CH4H2-CH4-1bar-TPOT-Input-B - Original.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.004923143105041647
exported_pipeline = make_pipeline(
    make_union(
        StackingEstimator(estimator=RidgeCV()),
        FunctionTransformer(copy)
    ),
    ExtraTreesRegressor(bootstrap=False, max_features=0.9000000000000001, min_samples_leaf=2, min_samples_split=2, n_estimators=100)
)
