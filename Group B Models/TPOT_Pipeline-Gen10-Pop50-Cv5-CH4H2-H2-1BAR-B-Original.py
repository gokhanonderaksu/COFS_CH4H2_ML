...
tpot_data = pd.read_csv('C:/Users/gaksu/Desktop/github/Raw Data/HypoCOF-CH4H2-H2-1bar-TPOT-Input-B - Original.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -8.925986292218651e-07
exported_pipeline = make_pipeline(
    PolynomialFeatures(degree=2, include_bias=False, interaction_only=False),
    StackingEstimator(estimator=LassoLarsCV(normalize=False)),
    GradientBoostingRegressor(alpha=0.8, learning_rate=0.1, loss="ls", max_depth=5, max_features=0.9000000000000001, min_samples_leaf=1, min_samples_split=9, n_estimators=100, subsample=0.25)
)
