...
tpot_data = pd.read_csv('C:/Users/gaksu/Desktop/github/Raw Data/HypoCOF-CH4H2-CH4-0.1bar-TPOT-Input-B - Original.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.00010773743167071823
exported_pipeline = make_pipeline(
    PCA(iterated_power=7, svd_solver="randomized"),
    StackingEstimator(estimator=RidgeCV()),
    XGBRegressor(learning_rate=0.1, max_depth=4, min_child_weight=7, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.9000000000000001, verbosity=0)
)
