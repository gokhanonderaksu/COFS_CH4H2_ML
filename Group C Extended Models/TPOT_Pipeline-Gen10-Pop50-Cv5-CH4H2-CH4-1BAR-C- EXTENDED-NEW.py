...
tpot_data = pd.read_csv('C:/Users/gaksu/Desktop/github/Raw Data/HypoCOF-CH4H2-CH4-1bar-TPOT-Input-C- EXTENDED-NEW.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.006845625459079766
exported_pipeline = make_pipeline(
    PolynomialFeatures(degree=2, include_bias=False, interaction_only=False),
    StackingEstimator(estimator=LassoLarsCV(normalize=False)),
    ExtraTreesRegressor(bootstrap=False, max_features=0.55, min_samples_leaf=1, min_samples_split=16, n_estimators=100)
)
