...
tpot_data = pd.read_csv('C:/Users/gaksu/Desktop/github/Raw Data/HypoCOF-CH4H2-H2-1bar-TPOT-Input-C- EXTENDED-NEW.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -4.701844567373969e-06
exported_pipeline = ExtraTreesRegressor(bootstrap=False, max_features=0.9500000000000001, min_samples_leaf=1, min_samples_split=4, n_estimators=100)
