...
tpot_data = pd.read_csv('C:/Users/gaksu/Desktop/github/Raw Data/HypoCOF-CH4H2-CH4-0.1bar-TPOT-Input-C- EXTENDED-NEW.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.00014867184353625605
exported_pipeline = make_pipeline(
    PolynomialFeatures(degree=2, include_bias=False, interaction_only=False),
    MaxAbsScaler(),
    ExtraTreesRegressor(bootstrap=False, max_features=0.9500000000000001, min_samples_leaf=3, min_samples_split=4, n_estimators=100)
)
...
X_unseen = pd.read_csv('C:/Users/gaksu/Desktop/KodSystems/TPOT/CH4-H2/Unseen - Class 1 - Subset - CH4.csv', sep=',')
