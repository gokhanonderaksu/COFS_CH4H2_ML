...
tpot_data = pd.read_csv('C:/Users/gaksu/Desktop/github/Raw Data/HypoCOF-CH4H2-H2-1bar-TPOT-Input-C - Original.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -2.7169396441005055e-06
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=SGDRegressor(alpha=0.01, eta0=0.01, fit_intercept=True, l1_ratio=1.0, learning_rate="constant", loss="huber", penalty="elasticnet", power_t=0.0)),
    XGBRegressor(learning_rate=0.1, max_depth=8, min_child_weight=2, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.6500000000000001, verbosity=0)
)
...
X_unseen = pd.read_csv('C:/Users/gaksu/Desktop/KodSystems/TPOT/CH4-H2/Unseen - Class 3 - Subset - H2.csv', sep=',')
