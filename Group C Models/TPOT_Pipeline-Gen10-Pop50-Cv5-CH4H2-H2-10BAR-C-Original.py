...
tpot_data = pd.read_csv('C:/Users/gaksu/Desktop/github/Raw Data/HypoCOF-CH4H2-H2-10bar-TPOT-Input-C - Original.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.0002568583926304746
